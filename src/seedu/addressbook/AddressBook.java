...
public class AddressBook {
    ...
    /**
     * Using the HashMap<String, String> to store the details of a single person.
     */
     ...
     */
    private static boolean isDisplayIndexValidForLastPersonListingView(int index) { // complicated expression
